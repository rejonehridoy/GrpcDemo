...
using CatalogService.DataServices.Grpc;
...
namespace CatalogService
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddDbContext<ApplicationDbContext>(item => item.UseSqlServer(Configuration.GetConnectionString("ProductCatalog")));
